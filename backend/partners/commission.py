...
# «Окно атрибуции — год с момента перехода по ссылке». Момент перехода
# отдельно нигде не хранится (ref_code живёт в localStorage до регистрации,
# см. frontend/src/utils/refCode.js) — created_at приглашённого фактически
# совпадает с ним: ref_code привязывается к referred_by именно в момент
# создания аккаунта, не раньше и не позже.
