...
function NatalChartInner({
  ...
  const discBase        = dark ? 'rgba(26,18,48,0.55)'    : '#FDFBF9';  /* zodiac data-color, intentional */
  const discInner       = dark ? 'rgba(26,18,48,0.60)'    : '#FFFFFF';
  const discInnerStroke = dark ? 'rgba(var(--accent-rgb),0.25)'  : '#EDE8F5';  /* zodiac data-color, intentional */
      ...
      {planetPositions.map((planet, planetIdx) => {
        ...
        return (
          ...
          >
            ...
            <circle cx={glyphPos.x} cy={glyphPos.y} r={r} fill={dark ? '#1A1230' : '#FFFFFF'} /* zodiac data-color, intentional */ />
              ...
              return (
                <g key={`tg-${i}`}>
                  ...
                  <g className="transit-planet" style={{ transform: `translate(${pos.x}px, ${pos.y}px)` }}>
                    <circle cx={0} cy={0} r={12} fill={dark ? '#1A1230' : '#FFFFFF'} /* zodiac data-color, intentional */ />
