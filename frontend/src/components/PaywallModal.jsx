...
const PAYWALL_CONTENT = {
  free_to_lite: {
    ...
    benefits: [
      ...
      { icon: '🗺️', text: 'Построение и сохранение карт до 5 в месяц' },
      { icon: '📆', text: 'Планер Timeline на один месяц' },
      { icon: '🔭', text: 'Просмотр всех транзитов' },
    ],
  ...
  lite_to_pro: {
    ...
    subtitle: 'AI-интерпретации, транзиты и чат-ассистент',
    benefits: [
      { icon: '🗺️', text: 'Построение и сохранение 20 карт в месяц' },
      { icon: '🔮', text: 'AI-интерпретации 15 натальных карт — 2500 слов' },
      { icon: '🪐', text: 'Транзиты — просмотр + AI-объяснение' },
      { icon: '💬', text: 'RAG-чат: задайте любой вопрос о своей карте' },
      { icon: '📆', text: 'Планер Timeline на год' },
