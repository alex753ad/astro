...
const BENEFITS = [
  {
    icon: '🪐',
    title: 'Транзиты до 6 месяцев',
    desc: 'Смотри активные периоды планет и их влияние на твою карту',
  },
  {
    icon: '📖',
    title: 'Полная интерпретация',
    desc: 'Развёрнутый анализ до 2000 слов — все планеты, дома и аспекты',
  },
  {
    icon: '🗂',
    title: 'До 10 профилей',
    desc: 'Сохраняй карты близких и переключайся между ними',
  },
];
