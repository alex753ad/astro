...
const PAYWALL_CONTENT = {
  free_to_lite: {
    ...
    title: 'Какой планетарный период сейчас влияет на твою жизнь',
    ...
    benefits: [
      ...
      { text: 'Виральная карточка твоей карты для Stories' },
    ],
  ...
  lite_to_pro: {
    ...
    subtitle: 'Компенсации под твою карту и астролог Аристея, которая помнит, о чём шла речь',
    benefits: [
      { text: 'Чат с астрологом Аристеей: знает твою карту и помнит суть прошлых разговоров — как консультант, который тебя уже знает' },
      { text: 'Разбор каждого транзита: что Сатурн в твоём 7-м доме значит и как его мягче прожить' },
  ...
  pro_to_premium: {
    ...
    benefits: [
      ...
      { text: 'PDF-отчёты с твоим брендингом — клиент уходит с документом' },
