...
const PAYWALL_CONTENT = {
  ...
  lite_to_pro: {
    ...
    title: 'Вы видите транзит — Аристея говорит, что в нём делать',
    subtitle: 'Компенсации под вашу карту и астролог Аристея, которая помнит, о чём вы говорили',
    benefits: [
      { text: 'Чат с астрологом Аристеей: знает вашу карту и помнит суть прошлых разговоров — как консультант, который вас уже знает' },
