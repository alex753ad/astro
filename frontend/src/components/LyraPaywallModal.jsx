...
const DEFAULT_FEATURES = [
  ...
  { icon: "chat", text: "Чат с астрологом Астреей, которая уже знает вашу карту" },
...
export default function LyraPaywallModal({
  ...
  subtitle = "Астролог Астрея знает вашу карту, помнит суть прошлых разговоров и объясняет, что каждый период значит именно для вас.",
