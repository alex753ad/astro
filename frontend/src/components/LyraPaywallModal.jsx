...
const DEFAULT_FEATURES = [
  ...
  { icon: "chat", text: "Чат с астрологом Аристеей, которая уже знает твою карту" },
...
export default function LyraPaywallModal({
  ...
  onContinueFree,
  contextLabel,
  title = "Разбор этого транзита по твоей карте",
  subtitle = "Астролог Аристея знает твою карту, помнит суть прошлых разговоров и объясняет, что каждый период значит именно для тебя.",
