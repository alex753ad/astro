...
const TOOLTIPS = [
  {
    id: 'asc',
    title: 'Асцендент (AC)',
    text: 'Твоя маска для мира — то, каким тебя видят окружающие при первом знакомстве.',
    icon: '↑',
  },
  {
    id: 'mc',
    title: 'Середина Неба (MC)',
    text: 'Твоё призвание и публичный образ — то, к чему ты стремишься в карьере и обществе.',
    icon: '★',
  },
  {
    id: 'aspects',
