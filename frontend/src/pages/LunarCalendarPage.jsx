...
const pg = {
  page: {
    ...
    // ⚠️ До 14.09.2026 здесь стоял литерал со своим стеком: у Space Grotesk не
    // было кириллицы, и эта страница намеренно проваливалась в Inter, тогда как
    // остальной сайт — в системный шрифт. Расхождение было настоящим и видимым.
    // Со сменой пары причина исчезла: кириллица есть у обеих гарнитур.
