...
const s = {
  ...
  warn:    { background: '#1e1a0e', border: '1px solid #854d0e', borderRadius: 10, padding: '16px 20px', marginBottom: 10, color: '#fcd34d', fontSize: 14, lineHeight: 1.7 },
  ...
  return (
    <div style={s.page}>
      <div style={s.inner}>
        ...
        <p style={s.p}>
          Оплата производится через Stripe. Подписка автоматически продлевается. Вы можете отменить
