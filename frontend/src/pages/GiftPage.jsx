...
const S = {
  page:    { minHeight: '100vh', background: '#0f172a', color: '#e2e8f0', fontFamily: "'Inter', system-ui, sans-serif", padding: '40px 16px' },
  inner:   { maxWidth: 720, margin: '0 auto' },
  h1:      { fontSize: 28, fontWeight: 800, margin: '0 0 8px', background: 'linear-gradient(90deg,#7C6CFF,#38bdf8)', WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent' },
  sub:     { color: '#94a3b8', marginBottom: 40, fontSize: 16 },
  section: { marginBottom: 32 },
  label:   { fontSize: 13, fontWeight: 700, color: '#94a3b8', textTransform: 'uppercase', letterSpacing: '0.06em', marginBottom: 12 },
  row:     { display: 'flex', gap: 12, flexWrap: 'wrap' },
  card:    (selected, color) => ({
    flex: '1 1 160px',
    background: selected ? 'rgba(124,108,255,0.12)' : '#1e293b',
  ...
  durCard: (selected) => ({
    flex: '1 1 100px',
    background: selected ? 'rgba(124,108,255,0.15)' : '#1e293b',
    border: `2px solid ${selected ? '#7C6CFF' : '#334155'}`,
    borderRadius: 10,
    padding: '12px 16px',
    cursor: 'pointer',
    textAlign: 'center',
  ...
  badge: { position: 'absolute', top: -10, right: -10, background: '#7C6CFF', color: '#fff', fontSize: 11, fontWeight: 700, padding: '2px 7px', borderRadius: 99 },
  priceBox: { background: '#1e293b', border: '1px solid #334155', borderRadius: 12, padding: '20px 24px', marginBottom: 24, display: 'flex', justifyContent: 'space-between', alignItems: 'center' },
  price:  { fontSize: 32, fontWeight: 800, color: '#e2e8f0' },
  btn:    (disabled) => ({
    width: '100%',
    padding: '16px',
    background: disabled ? '#334155' : 'linear-gradient(90deg,#7C6CFF,#38bdf8)',
    border: 'none',
    borderRadius: 12,
    color: '#fff',
    fontSize: 16,
  ...
  redeemBox: { background: '#1e293b', border: '1px solid #334155', borderRadius: 12, padding: '24px', marginTop: 48 },
  input: { width: '100%', boxSizing: 'border-box', background: '#0f172a', border: '1px solid #334155', borderRadius: 8, color: '#e2e8f0', fontSize: 15, padding: '12px 14px', marginBottom: 12, letterSpacing: 2, textTransform: 'uppercase' },
  success: { background: 'rgba(34,197,94,0.1)', border: '1px solid #22c55e', borderRadius: 8, padding: '12px 16px', color: '#86efac', marginTop: 12 },
  error:   { background: 'rgba(239,68,68,0.1)', border: '1px solid #ef4444', borderRadius: 8, padding: '12px 16px', color: '#fca5a5', marginTop: 12 },
};
    ...
    <div style={S.page}>
      <div style={S.inner}>
        ...
        <div style={S.priceBox}>
          <div>
            <div style={{ color: '#94a3b8', fontSize: 14 }}>К оплате</div>
        ...
        <div style={S.redeemBox}>
          ...
          <div style={{ color: '#94a3b8', fontSize: 13, marginBottom: 16 }}>Введите полученный код ниже</div>
          <input
            style={S.input}
