        ...
        >
          {[
            ...
            },
            {
              ...
              desc: 'Аристея собирает бриф по клиенту заранее: карта, актуальные транзиты, главные темы периода. Вы приходите на консультацию собранным и глубоким, а время до неё остаётся вашим.',
            },
            {
