...
describe('планета к своей же точке', () => {
  ...
  it('у самого частого случая формулировка живая, а не канцелярская', () => {
    ...
    expect(transitTeaserText(own('Moon', 'trine')))
      .toBe('Луна к вашей Луне: между ключевыми точками собственного цикла, тема чувств. Мягкий аспект, окно несколько часов.');
  ...
  it('фаза не пропадает ни у одного аспекта', () => {
    ...
    // бы «Луна к вашей Луне: тема чувств» половине событий, ради которой фаза
