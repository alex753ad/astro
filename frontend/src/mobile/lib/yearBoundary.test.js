...
describe('прогнозные дни через Новый год и 29 февраля', () => {
  it('31.12 в 23:30 открыты 31.12 и 01.01', () => {
    expect(forecastDates('2026-12-31', 23)).toEqual(['2026-12-31', '2027-01-01']);
  });
  it('01.01 в 00:30 — только 01.01: вчера нет, завтра ещё закрыт', () => {
    expect(forecastDates('2027-01-01', 0)).toEqual(['2027-01-01']);
  });
  it('високосный февраль', () => {
    expect(forecastDates('2028-02-28', 20)).toEqual(['2028-02-28', '2028-02-29']);
    expect(forecastDates('2028-02-29', 20)).toEqual(['2028-02-29', '2028-03-01']);
