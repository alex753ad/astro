...
const FREE_SPENT = 'Вы использовали бесплатную интерпретацию. Оформите Вегу, чтобы разбирать карты дальше.';
const TIER_LIMIT = 'Лимит 5 интерпретаций в месяц исчерпан для тарифа Вега. Оформите более высокий тариф.';
