...
/**
 * Даты, у которых в ленте есть карточка прогноза: сегодня и — с 19:00 —
 * завтра. До 19:00 завтрашней карточки нет совсем, не заглушка (решение
 * владельца). Прогноза на вчера нет с 24.09.2026 (решение владельца): сервер
 * отвечает на прошлую дату 404.
 */
 ...
 * прогноза; с 24.09.2026 то же (с 19:00) у завтра. Без вставки
