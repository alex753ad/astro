 ...
 *
 * Линия рвётся на липком заголовке дня (`FeedDayHeader.jsx`) — он живёт вне
 * узла и линии не рисует. Непрерывность через день — открытый пункт
 * устройства (§10), не решённый здесь архитектурно.
 *
