  ...
  return (
    <div style={{ position: 'relative', paddingBottom: gap }}>
      ...
      <div style={{ display: 'flex', minHeight: (hasDot && !dense) ? 44 : undefined }}>
        ...
        {/* ⚠️ 8px — зазор между вертикальной линией и содержимым. Было 16:
            рамка карточки периода стояла вровень со значками транзитов, и это
            выглядело аккуратно, но стоило расшифровке двух строк на каждом
            абзаце. Решение владельца 16.09.2026: ширина важнее выравнивания,
            рамка теперь левее значков — это принято, а не недосмотр. */}
