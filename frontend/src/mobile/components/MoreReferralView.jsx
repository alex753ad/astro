 ...
 * системным шерингом: `@capacitor/share` не ставим, потому что копирование
 * закрывает задачу целиком, а не потому, что плагин был бы вторым (правило
 * «один плагин на приложение» отменено 10.09.2026). Тот же выбор и по той же
 * причине сделан в `lib/shareRules.js`; появится системный лист — переводить
 * оба места сразу.
 */
