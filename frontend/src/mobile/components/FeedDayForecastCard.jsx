 ...
 *
 * Дни с карточкой: сегодня и — с 19:00 — завтра (feedAnchor.js,
 * forecastDates; решения владельца 23 и 24.09.2026). Текст один и тот же для
 * дня в обеих ролях — сервер пишет его без «сегодня/завтра», а
...
export default function FeedDayForecastCard({ chartId, date, label, open, onToggle }) {
   ...
   * Ключ кэша — дата карточки, так что текст другой даты под «сегодня» не встанет.
